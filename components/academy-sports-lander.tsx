...
const AFFILIATE_LINK = "https://trksy.org/aff_c?offer_id=4713&aff_id=26188"

const BLUE = "#0055A4"
const BLUE_DEEP = "#00325F"
const BLUE_BRIGHT = "#2E7BC4"
const INK = "#111213"
...
const CATEGORIES = [
  {
    t: "Fitness & Training",
    d: "Dumbbells, mats, and resistance bands.",
    icon: "M6 8v8 M18 8v8 M3 10v4 M21 10v4 M6 12h12",
  },
  {
    t: "Outdoor & Camping",
    d: "Tents, coolers, and camp chairs.",
    icon: "M12 4L2 20h20L12 4z M12 12l-4.5 8 M12 12l4.5 8",
  },
  {
    t: "Team Sports",
    d: "Cleats, gloves, and basketballs.",
    icon: "M12 3a9 9 0 100 18 9 9 0 000-18z M3.5 9.5c5 2 12 2 17 0 M3.5 14.5c5-2 12-2 17 0",
  },
  {
    t: "Fishing & Gear",
    d: "Rod combos, tackle kits, and vests.",
    icon: "M3 12c4-5 10-5 14 0-4 5-10 5-14 0z M17 12l4-4v8l-4-4 M7.5 11h.01",
  },
]
  ...
  return (
    <div className="relative grid grid-cols-[3rem_1fr] md:grid-cols-[1fr_3.5rem_1fr] gap-x-4 md:gap-x-8 items-center pb-6 md:pb-8 last:pb-0">
      <div
        ...
        aria-hidden="true"
      >
        <span className="font-black text-6xl lg:text-7xl leading-none select-none" style={{ color: "#E7F0F8" }}>
          0{index + 1}
        </span>
      </div>
      ...
      <div className="order-1 md:order-2 flex justify-center self-start md:self-center pt-1 md:pt-0">
        <div
          ...
          style={{
            ...
            borderColor: BLUE,
            color: "#FFFFFF",
            boxShadow: "0 8px 22px rgba(0,85,164,.35)",
          }}
        >
          {index + 1}
        </div>
...
export default function AcademySportsRewardLander() {
  ...
  return (
    <div className="min-h-screen bg-white antialiased overflow-x-hidden font-sans" style={{ color: INK }}>
      <style>{`
        ...
        .card-shine { position: absolute; inset: 0; pointer-events: none; background: linear-gradient(115deg, transparent 35%, rgba(0,85,164,0.05) 47%, rgba(255,255,255,0.55) 52%, transparent 65%); background-size: 260% 100%; animation: cardShine 7s ease-in-out infinite; }
        ...
        .cat-spark { position: absolute; top: 16px; right: 18px; color: #0055A4; animation: sparkTwinkle 3.4s ease-in-out infinite; }
        ...
        .t-card:hover { transform: translateY(-6px); border-color: rgba(0,85,164,.35); box-shadow: 0 18px 44px rgba(0,85,164,.12); }
        .t-rail-fill { background: linear-gradient(180deg, #2E7BC4, #0055A4); }
      ...
      >
        <div className="orb w-96 h-96 -top-24 -left-24" style={{ backgroundColor: "#3D85C6" }} />
        <div
          className="orb w-80 h-80 top-1/3 -right-20"
          style={{ backgroundColor: "#00325F", animationDelay: "-6s" }}
        />
        ...
        <div className="relative mx-auto max-w-3xl px-6 pt-12 pb-20 md:pt-20 md:pb-24 text-center">
          <div className="text-white">
            ...
            <h1 className="mt-6 font-black tracking-tight leading-[1.05] text-[1.65rem] min-[360px]:text-[1.85rem] sm:text-5xl md:text-6xl text-balance">
              {"The Academy Sports Discounts They Don't Advertise"}
            </h1>
            <p className="mt-6 text-lg md:text-xl text-white/85 max-w-xl mx-auto leading-relaxed text-pretty">
              Discover how shoppers are unlocking hidden discount codes on fitness gear, camping equipment, team sports,
              and fishing tackle.
            </p>
      ...
      >
        ...
        <div className="orb w-96 h-96 -top-24 -left-24" style={{ backgroundColor: "#5B9BD3", opacity: 0.35 }} />
        <div
          className="orb w-80 h-80 -bottom-24 -right-16"
          style={{ backgroundColor: "#00325F", animationDelay: "-5s" }}
        />
