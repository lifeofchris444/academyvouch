  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          The{" "}
          <span className="text-[#0054a6] font-semibold">Academy Sports</span>{" "}
        ...
        >
          Discover how people are saving on sporting goods, outdoor gear, athletic apparel, and footwear.
        </p>
        ...
        >
          <a
            ...
            className="touch-button group inline-flex items-center gap-3 bg-[#0054a6] text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#004085] transition-all duration-300 hover:shadow-xl hover:shadow-[#0054a6]/20 hover:-translate-y-0.5"
          >
            APPLY NOW
